...
new_password=$(python -c "import urllib;print urllib.quote(raw_input(), safe='')" <<< "admin")
fullname=$(python -c "import urllib;print urllib.quote(raw_input(), safe='')" <<< "Administartor")
email=$(python -c "import urllib;print urllib.quote(raw_input(), safe='')" <<< "admin@admin.com")
